...
import com.example.fernando.menudeslisante.view.fragments.AdicionarQuestoesFragment;
import com.example.fernando.menudeslisante.view.fragments.ListaProvasFragment;
...
public class MenuActivity extends AppCompatActivity
    ...
    public void onClickPlus(View v){
        AdicionarQuestoesFragment op2= new AdicionarQuestoesFragment();
        replaceFragment(op2);
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_opcao1:
                ListaProvasFragment op1= new ListaProvasFragment();
                replaceFragment(op1);
